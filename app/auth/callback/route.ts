...
<style>html{-webkit-text-size-adjust:100%;text-size-adjust:100%}body{margin:0;display:flex;min-height:100vh;align-items:center;justify-content:center;background:#f7ebdb;color:#11233a;font-family:-apple-system,BlinkMacSystemFont,"Apple SD Gothic Neo",sans-serif}main{text-align:center}.spin{box-sizing:border-box;margin:0 auto 14px;width:36px;height:36px;border-radius:50%;border:3px solid rgba(17,35,58,.15);border-top-color:#11233a;animation:s .8s linear infinite}h1{font-size:20px;line-height:28px;font-weight:600;margin:0}p{font-size:14px;line-height:20px;color:rgba(17,35,58,.55);margin:6px 0 0}@keyframes s{to{transform:rotate(360deg)}}</style>
</head>
<body>
<main>
  ...
  return new Response(CALLBACK_SHELL, {
    ...
    headers: {
      ...
      "Content-Security-Policy":
        ...
        "style-src 'sha256-jpaTjHm0eSxBJxZVuFGIotYWR5UoAcY0TRSj1Kj0Vao='; " +
