...
/**
 * 공유·유입 분석 「집계」 — 게임플레이 분석(/admin/analytics)과 성격이 달라 별도 탭으로 격리.
 * 제목·2차 탭(집계 | 원본 이벤트)은 app/admin/acquisition/layout.tsx(v1.31).
  ...
  return (
    <>
      ...
      <p className="-mt-2 text-xs text-zinc-400">
        ...
        공유 행동·유입 경로 전용. 원본(UA·레퍼러 원문)은 「원본 이벤트」 탭.
        <br />
        오늘은 실시간(raw), 어제까지는 일 단위 확정 집계예요. 방문은 첫 터치·스크롤 등 상호작용이 있었던 방문만 세요.
      </p>
