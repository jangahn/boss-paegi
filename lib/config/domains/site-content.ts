...
export const SITE_CONTENT_DEFAULT: SiteContent = {
  ...
  metaDescription:
    "내 사진으로 만든 AI 캐릭터를 제한 시간 동안 두들겨 직장 스트레스를 푸는 무료 캐주얼 웹게임. 설치 없이 웹에서 바로 즐기고, 만 19세 이상이면 누구나 이용할 수 있어요.",
  keywords: [
    "부장님 패기",
    "스트레스 해소 게임",
    "직장인 게임",
  ...
  intro:
    "부장님 패기는 직장 스트레스를 가볍게 푸는 캐주얼 웹게임입니다. 내 사진을 올리면 AI가 실제 인물과 닮지 않은 캐릭터로 바꿔 주고, 제한 시간 동안 그 캐릭터를 두들겨 점수와 랭킹에 도전합니다. 설치 없이 웹브라우저에서 바로 즐길 수 있고, 만 19세 이상이면 누구나 이용할 수 있습니다. 업로드한 원본 사진은 생성 직후 폐기됩니다.",
  faq: [
    {
      q: "부장님 패기란 무엇인가요?",
    ...
    {
      q: "무료인가요? 요금은 어떻게 되나요?",
      a: "게임 플레이는 무료입니다. 내 사진으로 AI 캐릭터를 만들 때만 '생성권'이 1개 사용되며, 가입하면 생성권 1개를 무료로 드립니다. 추가 생성권은 충전(유료)할 수 있고 결제 완료 즉시 지급됩니다. 미사용 생성권의 환불 등 자세한 기준과 절차는 이용약관을 확인해주세요.",
    },
    {
