// Minimal Node test resolver for Next aliases and extensionless TypeScript imports.
...
export async function resolve(specifier, context, nextResolve) {
  ...
  if (specifier.startsWith("next/") && !specifier.endsWith(".js")) {
    try {
      ...
      // Fall through to Node's normal error if this is not a file-style Next subpath.
    }
  }
