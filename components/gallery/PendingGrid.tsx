...
function PendingCard({ gen }: { gen: PendingGeneration }) {
  ...
  return (
    <Link
      ...
      className="group relative flex aspect-square flex-col overflow-hidden rounded-2xl border border-emerald-500/40 ui-surface transition hover:border-emerald-500/70"
    >
