...
export const REFUND_ERR_KO: Record<string, string> = {
  ...
  economic_resolution_required: "늦은 결제는 전액 경제 환불이 확인된 뒤에만 해소할 수 있어요.",
  ...
  action_unconfirmed: "처리 결과를 증명하지 못했어요 — 같은 요청으로 결과를 다시 확인하세요.",
  refund_begin_transport_failed: "환불 준비 응답을 받지 못했어요.",
  invalid_refund_begin_ack: "환불 준비 영수증이 올바르지 않아요.",
  refund_intent_conflict: "확인되지 않은 이전 환불 요청과 입력값이 달라요.",
  refund_receipt_storage_unavailable: "브라우저에 환불 영수증을 안전하게 보관할 수 없어요.",
  refund_receipt_correlation_mismatch: "보관된 환불 영수증과 처리 대상이 일치하지 않아요.",
  refund_cross_tab_lock_unavailable: "브라우저의 탭 간 환불 잠금을 사용할 수 없어요.",
  refund_already_in_progress: "다른 탭에서 같은 주문의 환불을 처리 중이에요.",
  cancel_cross_tab_lock_unavailable: "브라우저의 탭 간 주문 취소 잠금을 사용할 수 없어요.",
  cancel_already_in_progress: "다른 탭에서 같은 주문 취소를 처리 중이에요.",
  cancel_receipt_storage_unavailable: "브라우저에 주문 취소 영수증을 안전하게 보관할 수 없어요.",
  invalid_cancel_intent: "주문 취소 입력값이 올바르지 않아요.",
  cancel_intent_conflict: "확인되지 않은 이전 주문 취소와 입력값이 달라요.",
  cancel_receipt_correlation_mismatch: "보관된 주문 취소 영수증과 처리 대상이 일치하지 않아요.",
  cancel_transport_failed: "주문 취소 응답을 받지 못했어요. 같은 내용으로 다시 시도하세요.",
  invalid_cancel_ack: "주문 취소 결과 영수증이 올바르지 않아요.",
