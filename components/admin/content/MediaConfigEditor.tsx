...
> = {
  ...
  logo: {
    label: "서비스 로고",
    // 홈·로그인 로고 자리는 4:3 고정(v1.60) — 미리보기도 같은 비율로 보여 준다. 다른 비율은 자리 안에 맞춰(contain) 작게 보인다.
    hint: "홈·로그인 상단 로고. 투명 배경 PNG/WebP 권장, 가로 4:3 비율로(홈 자리 4:3 고정 — 다른 비율은 자리 안에 작게 맞춰져요). 미설정 시 기본 로고를 사용합니다.",
    box: "aspect-[4/3] w-28",
    fit: "contain",
    minW: 320,
    minH: 240,
